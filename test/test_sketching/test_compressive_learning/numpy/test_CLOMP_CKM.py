...
def test_fit_once():
    ...
    Phi_emp = MatrixFeatureMap("ComplexExponential", Omega, use_torch=False)
    ...
    ckm_solver = CLOMP_CKM(phi=Phi_emp, nb_mixtures=nb_clust, bounds=bounds, sketch=z, opt_method="pdfo")
