...
from pycle.sketching import fourierSketchOfGaussian, MatrixFeatureMap
...
class CLOMP_dGMM(CLOMP):
    ...
    def __init__(self, Phi, K, bounds, sketch=None, sketch_weight=1., init_variance_mode="sketch", verbose=0):
        ...
        assert isinstance(Phi, GMMFeatureMap)
        ...
        super(CLOMP_dGMM, self).__init__(Phi, K, d_atom, bounds, sketch=sketch, sketch_weight=sketch_weight, verbose=verbose)
